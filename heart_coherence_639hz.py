...
# תדר 639 הרץ עם פער תהודת שומאן (7.83 הרץ) לאיזון רגשי
freq_left = 639.0
freq_right = 646.83
...
write('heart_coherence_639hz.py.wav', sample_rate, stereo_signal) # שים לב לשם הקובץ
print("קובץ איזון רגשי 639Hz נוצר בהצלחה!")