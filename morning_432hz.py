...
# תדר 432 הרץ עם פער בטא עדין לעירנות (12 הרץ)
freq_left = 432.0
freq_right = 444.0
...
pink_noise = (pink_noise / np.max(np.abs(pink_noise))) * 0.2
...
write('morning_432hz.wav', sample_rate, stereo_signal)
print("קובץ אנרגיית בוקר 432Hz נוצר בהצלחה!")