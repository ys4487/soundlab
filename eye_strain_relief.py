...
# תדר 528 הרץ עם פער תהודת שומאן (7.83 הרץ) להרפיית עייפות עיניים ומתח דיגיטלי
freq_left = 528.0
freq_right = 535.83
...
write('eye_strain_relief.wav', sample_rate, stereo_signal)
print("קובץ הרפיית עיניים ומתח דיגיטלי נוצר בהצלחה!")